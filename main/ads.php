        ...
        <div class="statbox widget box box-shadow">
            ...
            <form action="" method="POST"> 
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-xl-2 cabs_action">  
                            <div class="form-group"> 
                                <button type="submit" id="startAds" style="border: none; outline: none; background-color: white;">
                                ...
                                <button type="submit" id="stopAds" style="border: none; outline: none; background-color: white;">
                            ...
                            <div class="container"> 
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-xl-6">
                                        <select name="date_ads_refresh" class="form-control basic">
                                    ...
                                    <div class="col-lg-1 col-xl-1">
                                        <button type="submit" id="refreshAds" style="border: none; outline: none; background-color: white;">
                            ...
                            <div class="form-group"> 
                                <div class="container"> 
                                    <div class="row" hidden>
                                        ...
                                        <div class="col-lg-5 col-xl-5">
                                            <input type="number" name="count_ads_copies" class="form-control" placeholder="0">
                                        </div>
                                        <div class="col-lg-3 col-xl-3">
                                            <button type="submit" id="copyAds" style="border: none; outline: none; background-color: white;">
                ...
                <div id="ads_tbody">
                        ...
                        <?php include("additional_load/ads_load.php"); ?>
