...
?>
<!-- Template Modal -->
<div class="modal fade register-modal" id="templateModal" tabindex="-1" role="dialog" aria-labelledby="registerModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="max-width: 1200px;">
        <div class="modal-content" style="margin-top: 20px;">
    
            <div class="modal-header" id="registerModalLabel">
                <h4 class="modal-title">Добавить новый шаблон</h4>
                <button type="button" class="close template" data-dismiss="modal" aria-hidden="true"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
            </div>
          
            <div class="modal-body">
                <form id="template_form" class="mt-0" action="" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                <div class="row">
                                                    <input type="text" name="template" class="form-control" placeholder="Имя шаблона">
                                                    <small class="form-text text-muted">Введите имя шаблона</small>
                                        ...
                                        <div class="col-lg-4 col-xl-4">
                                            <div class="form-group mainSettings">
                                                <select name="objective" class="template_template form-control basic">
                                                    <option selected value='CONVERSIONS' dropdown-item>Конверсии</option>
                                                    <option value='LINK_CLICKS' dropdown-item>Траффик</option>
                                                </select>
                                            </div>
                                            <div class="form-group mainSettings">
                                                <select name="bid_strategy" class="template_template form-control basic">
                                            ...
                                            <div class="form-group mainSettings">
                                                <input disabled type="number" name='bid_amount' class="template_template form-control" placeholder="0">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-xl-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-xl-6">
                                                        <select placeholder="Страна" id="countries" name="countries[]" class="form-control form-small countries tagging" multiple="multiple">
                                                            <?php 
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-xl-12 mt-5">
                                            <div class="form-group">
                                                ...
                                                <select name="attribution_spec" class="template_template form-control basic">
                                        ...
                                        <div class="col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                ...
                                                <label class="switch s-primary">
                                                    <input name='targeting_optimization' value='targeting_optimization' class="template_template" checked type="checkbox" hidden>
                                                    <span class="slider round"></span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="template_auto_placement_children">
                                        <div class="row">
                                            <div class="col-lg-5 col-xl-5">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-xl-6">
                                                                <label class="new-control new-checkbox new-checkbox-rounded new-checkbox-text checkbox-primary">
                                                                    <input checked name='mobile' value='mobile' type="checkbox" class="template_template new-control-input">
                                                ...
                                                <div class="template_mobile_children">     
                                                    <div class="form-group">
                                                        <div class="container"> 
                                                            <div class="row">
                                                                <div class="col-lg-12 col-xl-12">
                                                                    <p>IOS</p>
                                                                    <label class="switch s-primary">
                                                                        <input name='IOS' value='IOS' class="template_template" checked type="checkbox" hidden>
                                                                        <span class="slider round"></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-xl-6">
                                                                        <select name="ios_version1" class="form-control basic">
                                                                            <!--2.0;2.1;2.2;3.0;3.1;3.2;4.0;4.1;4.2;4.3;5.0;5.1;6.0;6.1;7.0;7.1;8.0;8.1;8.2;8.3;8.4;9.0;9.1;9.2;9.3;10.0;10.1;10.2;10.3;11.0;11.1;11.2;11.3;11.4;12.0;12.1;12.2;12.3;12.4;13.0;13.3;13.4;13.5;13.6;13.7;14.0-->
                                                        ...
                                                        <div class="container"> 
                                                            <div class="row">
                                                                <div class="col-lg-12 col-xl-12">
                                                                    <p>Android</p>
                                                                    <label class="switch s-primary">
                                                                        <input name='Android' value='Android' class="template_template" checked type="checkbox" hidden>
                                                                        <span class="slider round"></span>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="template_android_box">
                                                        <div class="form-group">
                                                            <div class="container"> 
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-xl-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-xl-6">
                                                                        <select name="android_version1" class="form-control basic">
                                                                            <!--0.5;1.0;1.1;1.5;1.6;2.0;2.1;2.2;2.3;3.0;3.1;3.2;4.0;4.1;4.2;4.3;4.4;4.5;5.0;5.1;6.0;6.1;7.0;7.1;8.0;8.1;9.0;10.0;11.0-->
                                                                            <option value="2.0" selected dropdown-item>Любая (2.0≥)</option>
                                            ...
                                            <div class="col-lg-4 col-xl-4">
                                                ...
                                                <label class="switch s-primary  mb-4 mr-2">
                                                    <input class="template_template" id='publisher_platforms_facebook' name='publisher_platforms_facebook' value='publisher_platforms_facebook' checked type="checkbox" hidden>
                                                    <span class="slider round"></span>
                                                </label>
                                        
                                                <div class="form-group template_facebook">
                                                ...
                                                <label class="switch s-primary  mb-4 mr-2">
                                                    <input class="template_template" id="publisher_platforms_audience_network" name='publisher_platforms_audience_network' value='publisher_platforms_audience_network' checked type="checkbox" hidden>
                                                    <span class="slider round"></span>
                                                </label>
                                        
                                                <div class="form-group template_netw">
                                                    <label class="new-control new-checkbox new-checkbox-rounded new-checkbox-text checkbox-primary" style="font-size: 13px;">
                                            ...
                                            <div class="col-lg-3 col-xl-3 template_mobile_children">
                                                <p>Позиция в Instagram</p>
                                                <label class="switch s-primary  mb-4 mr-2">
                                                    <input class="template_template" id="publisher_platforms_instagram" name='publisher_platforms_instagram' value='publisher_platforms_instagram' checked type="checkbox" hidden>
                                                    <span class="slider round"></span>
                                                </label>
                                        
                                                <div class="form-group template_instagram">
                                                    <label class="new-control new-checkbox new-checkbox-rounded new-checkbox-text checkbox-primary" style="font-size: 13px;">
                                                ...
                                                <label class="switch s-primary  mb-4 mr-2">
                                                    <input class="template_template" id="publisher_platforms_messenger" name='publisher_platforms_messenger' value='publisher_platforms_messenger' checked type="checkbox" hidden>
                                                    <span class="slider round"></span>
                                                </label>
                                        
                                                <div class="form-group template_mess">
                                                    <label class="new-control new-checkbox new-checkbox-rounded new-checkbox-text checkbox-primary" style="font-size: 13px;">
                                        ...
                                        <div class="col-lg-6 col-xl-6">
                                            <div class="form-group" style="width:100%" >
                                                <select name="call_to_action" class="form-control basic">
                                                    ...
                                                    <option value="SHOP_NOW" dropdown-item>Купить сейчас</option>
                                                </select>
                                                <small class="form-text text-muted">Кнопка</small>
                                            </div>
                                            <!--<div class="form-group">
                                                <label class="new-control new-checkbox new-checkbox-rounded new-checkbox-text checkbox-primary" style="font-size: 13px;">
                                                    <input id="is_pixel" name="is_pixel" checked type="checkbox" class="template_template new-control-input">
                                            ...
                                            <div class="form-group">
                                                <input id="pixel_name" type="text" name="pixel_name" class="template_template form-control" placeholder="pixel_name">
